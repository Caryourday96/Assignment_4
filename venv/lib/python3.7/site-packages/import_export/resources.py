...
#EDITED BY ADETUNJI KAYODE
#In the before_import_row(self, row, **kwargs):
#this is added     def before_import(self, dataset, dry_run):
                  # dataset.insert_col(0, col=["", ] * dataset.height, header="id")
                # pass
#to make sure that the lack of id in the file is fixed automatically
...
class Resource(six.with_metaclass(DeclarativeMetaclass)):
    ...
    def get_instance(self, instance_loader, row):
        ...
        """
        return False #instance_loader.get_instance(row)
